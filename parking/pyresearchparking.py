...
def Base_Page():
    ...
    Login_Button = Button(root, text="Login", font=("Times New Roman", 18), bd=3, command=Login_Page, bg='tomato',
                          activebackground='#9068be')

    icon2 = PhotoImage(file="NewUser.png")
    NUsr = Label(root, image=icon2)
    NewUser_Button = Button(root, text="New User", font=("Times New Roman", 18), bd=3, command=BptoNu, bg='tomato',
                            activebackground='#9068be')
    icon3 = PhotoImage(file="Availability.png")
    Avai = Label(root, image=icon3)
    Availability_Button = Button(root, text="Availability", font=("Times New Roman", 18), bd=3, command=Availability,
                                 bg='tomato', activebackground='#9068be')
    Log.grid(row=2)
...
def Login_Page():
    ...
    Login_Button = Button(Login_GUI, text=" Login  ", command=validate, font=("Times New Roman", 32), bg='tomato',
                          activebackground='#9068be')
    NewUser_Button = Button(Login_GUI, text="New User", command=LptoNu, font=("Times New Roman", 32), bg='tomato',
                            activebackground='#9068be')
...
def NewUser_Page():
    ...
    lab10.grid(row=10)
    Submit_Button = Button(NewUser_GUI, text="Submit", command=DB_Reg, font=("Times New Roman", 25), bd=3, bg='tomato',
                           activebackground='#9068be')
...
def ParkingPolicy():
    messagebox.showinfo("Parking Policy",
...
def Book_Page():
    ...
    global VehTyp
    VehTyp = StringVar()
    R3 = Radiobutton(Book_GUI, text="Two Wheeler", variable=VehTyp, value="2 Wheeler", command=CalPrice2,
                     font=("Times New Roman", 32))
    R4 = Radiobutton(Book_GUI, text="Four Wheeler", variable=VehTyp, value="4 Wheeer", command=CalPrice4,
                     font=("Times New Roman", 32))
